...
//   return (
//     <div className="productDetailsPage mx-auto w-11/12 md:w-10/12 lg:w-9/12 flex items-start">
//       <Image
...
//               -
//             </span>
//             <span className="cartValue">{counter}</span>
      ...
      <div className="productInfo">
        ...
        <div className="addToCartBlock flex flex-col">
          <div className="counter flex flex-wrap">
            <span
              className="minus"
              onClick={() => decrementQuantity(detailspage.id)}
            >
              -
            </span>
            <span className="cartValue">{quantities[detailspage.id] || 1}</span>
            <span
              className="minus"
              onClick={() => incrementQuantity(detailspage.id)}
            >
              +
            </span>
          </div>
